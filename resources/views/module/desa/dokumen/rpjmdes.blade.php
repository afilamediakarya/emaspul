...
<div class="toolbar" id="kt_toolbar">
	<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <button class="btn btn_general btn-sm filter-btn" data-kt-drawer-show="true" data-kt-drawer-target="#side_form" id="button-side-form"><i class="fa fa-plus-circle" style="color:#ffffff" aria-hidden="true"></i> Tambah Dokumen RMJDes </button>
        </div>
...
<script>
    ...
    $(function () {
        ...
        control.checkJadwal('Dokumen Desa','Dokumen RPJMDes');
        control.form_upload();
