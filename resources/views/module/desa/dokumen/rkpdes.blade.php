...
<script>
    ...
    $(document).on('submit', ".form-data", function(e){
        ...
        if (type == 'add') {
            control.submitFormMultipart('/general/storeDocuments?jenis=rkpdes','Tambah','Dokumen RKPDes',element);
        }else{
            let id = $("input[name='id']").val();
            control.submitFormMultipart('/general/updateDocuments/'+id+'?jenis=rkpdes','Update','Dokumen RKPDes',element);
        }
    });
