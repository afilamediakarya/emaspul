        ...
        let columnDefs = [
            ...
            },
            {
                ...
                render: function(data, type, full, meta) {
                    ...
                    return `
                        <button href="javascript:;" ${disabled} type="button" data-id="${data.id}" data-kt-drawer-show="true" data-kt-drawer-target="#side_form" class="btn btn_green button-update btn-sm filter-btn">
