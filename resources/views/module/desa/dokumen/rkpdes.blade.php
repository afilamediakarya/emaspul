...
<div class="toolbar" id="kt_toolbar">
	<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <button class="btn btn_general btn-sm filter-btn" data-kt-drawer-show="true" data-kt-drawer-target="#side_form" id="button-side-form"><i class="fa fa-plus-circle" style="color:#ffffff" aria-hidden="true"></i> Tambah Dokumen RKPDes</button>
        </div>
           ...
           <form class="form-data">
                ...
                <div class="mb-10">
                    ...
                    <select name="nama_documents" class="form-control form-control-solid" id="nama_documents" required>
                        ...
                        <option value="Dokumen RKPDes Pokok">Dokumen RKPDes Pokok</option>
                        <option value="Dokumen RKPDes Perubahan">Dokumen RKPDes Perubahan</option>
                    </select>
                    <small class="text-danger nama_documents_error"></small>
                </div>
                <input type="hidden" id="referensi_nama_dokumen" name="referensi_nama_dokumen" value="dokumen_desa">
...
<script>
    ...
    $(document).on('submit', ".form-data", function(e){
        ...
        if (type == 'add') {
            control.submitFormMultipart('/general/storeDocuments?jenis=rkpdes&type=type_b','Tambah','Dokumen RKPDes',element);
        }else{
            let id = $("input[name='id']").val();
            control.submitFormMultipart('/general/updateDocuments/'+id+'?jenis=rkpdes&type=type_b','Update','Dokumen RKPDes',element);
        }
    });
    ...
    $(document).on('click','.button-update', function (e) {
        ...
        control.overlay_form('Update','Data RKPDes', url);
    })
        ...
        let columnDefs = [
            ...
            },
            {
                ...
                render: function(data, type, full, meta) {
                    ...
                    return `
                        <button title="Edit" href="javascript:;" ${disabled} type="button" data-id="${data.id}" data-kt-drawer-show="true" data-kt-drawer-target="#side_form" class="btn btn_green button-update btn-sm filter-btn btn-icon">
                        <i class="fa fa-edit" aria-hidden="true" style="color:white"></i></button>

                        <a title="Detail" href="javascript:;" type="button" data-id="${data.id}" data-jenis="${data.jenis_document}" data-bs-toggle="modal" data-bs-target="#kt_modal_1" class="btn btn-info button-detail btn-sm btn-icon"> 
