...
@section('button')
<a href="/akun-opd/dokumen/indikator-kinerja-kunci/export?type=export" target="_blank" role="button" class="btn btn-danger btn-sm ">  <svg width="13" height="14" viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a style="margin-left: 12px;" href="/akun-opd/dokumen/indikator-kinerja-kunci/export?type=excel" target="_blank" role="button" class="btn btn-success btn-sm "> <i class="fas fa-file-excel"></i>  Excel</a> 
@endsection
@section('content')
...
<script>
    ...
    $(function () {
        ...
        control.initDatatable('/akun-opd/dokumen/indikator-kinerja-kunci/export?type=datatable',columns,columnDefs);
