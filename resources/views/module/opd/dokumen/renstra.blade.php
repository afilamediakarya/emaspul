        ...
        let columnDefs = [
            ...
            },
            {
                ...
                render: function(data, type, full, meta) {
                    ...
                    return `
                        <button type="button" ${disabled} data-id="${data.id}" title="Edit" data-kt-drawer-show="true" data-kt-drawer-target="#side_form" class="btn btn_green button-update btn-sm filter-btn btn-icon">
