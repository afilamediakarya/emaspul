...
@section('button')
<button class="btn btn_general btn-sm " data-kt-drawer-show="true" data-kt-drawer-target="#side_form" id="button-side-form"><i class="fa fa-plus-circle" style="color:#ffffff" aria-hidden="true"></i> Tambah Dokumen Data Sektoral</button>
@endsection
@section('content')
           ...
           <form class="form-data">
                ...
                <div class="mb-10">
                    ...
                    <select name="nama_documents" class="form-control form-control-solid" id="nama_documents">
                        ...
                        <option value="Dokumen Sektoral">Dokumen Sektoral</option>
                    </select>
...
<script>
    ...
    $(document).on('click','#button-side-form', function () {
        ...
        control.overlay_form('Tambah','Data Sektoral');
    })
    ...
    $(document).on('submit', ".form-data", function(e){
        ...
        if (type == 'add') {
            control.submitFormMultipart('/general/storeDocuments?jenis=sektoral&type=type_a','Tambah','Dokumen Data Sektoral',element);
        }else{
            let id = $("input[name='id']").val();
            control.submitFormMultipart('/general/updateDocuments/'+id+'?jenis=sektoral&type=type_a','Update','Dokumen Data Sektoral',element);
        }
    });
    ...
    $(document).on('click','.button-update', function (e) {
        ...
        control.overlay_form('Update','Data Sektoral', url);
    })
    ...
    $(function () {
        ...
        control.initDatatable('/general/datatable-list?jenis=6&type=type_a',columns,columnDefs);
        control.form_upload();
