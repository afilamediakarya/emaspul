...
<script>
    ...
    $(document).on('submit', ".form-data", function(e){
        ...
        if (type == 'add') {
            control.submitFormMultipart('/general/storeDocuments?jenis=renja','Tambah','Dokumen Renja',element);
        }else{
            let id = $("input[name='id']").val();
            control.submitFormMultipart('/general/updateDocuments/'+id+'?jenis=renja','Update','Dokumen Renja',element);
        }
    });
    ...
    $(function () {
        ...
        control.initDatatable('/general/datatable-list?jenis=4',columns,columnDefs);
        control.form_upload();
