...
<div class="toolbar" id="kt_toolbar">
	<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <button class="btn btn_general btn-sm filter-btn" data-kt-drawer-show="true" data-kt-drawer-target="#side_form" id="button-side-form"><i class="fa fa-plus-circle" style="color:#ffffff" aria-hidden="true"></i> Tambah Dokumen Renja</button>
        </div>
        ...
        <div class="modal-content rounded">
            ...
            <a href="#" id="konsederan" style="width: 18%" target="_blank" class="btn btn-danger mt-5 btn-sm">
               ...
               <div class="box_detail">
                   ...
                   <div class="row">
                        <div class="col-lg-6">
                            <span class="fz-12">Nomor</span>
                            <p class="fz-16 content_detail_4"></p>
                        </div>
                        <div class="col-lg-6">
                            <span class="fz-12">Tanggal</span>
        ...
        let columnDefs = [
            ...
            },
            {
                ...
                render: function(data, type, full, meta) {
                    ...
                    return `
                        <button type="button" ${disabled} data-id="${data.id}" title="Edit" data-kt-drawer-show="true" data-kt-drawer-target="#side_form" class="btn btn_green button-update btn-sm btn-icon">
