...
<div id="kt_content_container" class="container">
    <div class="row">
        ...
        <a href="/get-data/dashboard/export?type=export&document_type=4" target="_blank" role="button" class="btn btn-danger btn-sm ">  <svg width="13" height="14" viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg">
