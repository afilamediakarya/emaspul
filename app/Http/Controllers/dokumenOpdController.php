...
$html2 .= '</table>';
    ...
    public function html_render_renja($data,$jenis,$document){
        ...
        $html .= '<h4 style="text-align:center; line-height: 12pt;">BERITA ACARA <br> HASIL VERIFIKASI RANCANGAN RENCANA KERJA<br>'.strtoupper($data->unit_kerja).'<br> KABUPATEN ENREKANG TAHUN '.$data->tahun.'<hr></h4>';
...
$html2 = '<h4 style="text-align:center; line-height: 12pt;">FORMULIR VERIFIKASI RANCANGAN RENCANA KERJA <br>'.strtoupper($data->unit_kerja).'<br> KABUPATEN ENREKANG TAHUN '.$data->tahun.'<hr></h4>';
